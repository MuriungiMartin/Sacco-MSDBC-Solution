...
Report 50427 "Members Awaiting Exit Report"
{
    ...
    dataset
    {
        dataitem("Members Register"; "Members Register")
        {
            ...
            column(FOSASharesAccountNo_MembersRegister; "Members Register"."FOSA Shares Account No")
            {
            }
            column(TLoansGuaranteed_MembersRegister; "Members Register".TLoansGuaranteed)
            {
            }
            column(Dormancy_MembersRegister; "Members Register".Dormancy)
            {
            }
            ...
            column(WithdrawalApplicationDate_MembersRegister; "Members Register"."Withdrawal Application Date")
            {
            }
            column(ReasonForMembershipWithdraw_MembersRegister; "Members Register"."Reason For Membership Withdraw")
            {
            }
