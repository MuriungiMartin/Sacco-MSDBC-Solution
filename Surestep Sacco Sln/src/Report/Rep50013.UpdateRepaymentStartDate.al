...
Report 50624 "Update Repayment Start Date"
{
    ...
    dataset
    {
        dataitem("Members Register"; "Members Register")
        {
            ...
            begin
                "Members Register"."Individual Category" := 'Other';
                "Members Register"."Member Residency Status" := 'Resident';
                "Members Register"."Individual Category" := 'None of the above industries';
                "Members Register".Entities := '';
                "Members Register"."Length Of Relationship" := '0 ã 1 Year';
                "Members Register"."International Trade" := 'No';
                "Members Register"."Electronic Payment" := 'None of the Above';
                "Members Register"."Accounts Type Taken" := 'BOSA';
                "Members Register"."Cards Type Taken" := 'None';
                "Members Register"."Others(Channels)" := 'Unsolicited Account Origination e.g. Walk-Ins';
                "Members Register".Modify;
            end;
