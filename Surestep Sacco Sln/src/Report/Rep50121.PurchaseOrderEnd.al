...
dotnet // --> Reports ForNAV Autogenerated code - do not delete or modify
{
    ...
    {
        type(ForNav.Report_6_3_0_2259; ForNavReport51516121_v6_3_0_2259) { }
    }
...
Report 50121 "Purchase Order End"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CurrRepPageNo; StrSubstNo(Text005, Format(ReportForNav.PageNo)))
                    {
                    }
    ...
    var
        [WithEvents]
        ReportForNav: DotNet ForNavReport51516121_v6_3_0_2259;
