...
//     procedure ApplyEntries2(var BankAccReconLine: Record "Bank Acc. Reconciliation Line";var BankAccLedgEntry: Record "Bank Account Ledger Entry";Relation: Option "One-to-One","One-to-Many";BankAccStatementLine: Record "Cheque Book  Order Batch"): Boolean
//     begin
//         BankAccLedgEntry.LockTable;
//         CheckLedgEntry.LockTable;
//         BankAccReconLine.LockTable;
