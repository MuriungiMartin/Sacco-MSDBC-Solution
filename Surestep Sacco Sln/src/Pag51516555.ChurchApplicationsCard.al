...
// Page 50555 "Church Applications Card"
// {
//     DeleteAllowed = false;
//     PageType = Card;
...
//                         if ("Account Category"="account category"::Corporate) or ("Account Category"="account category"::Group) or ("Account Category"="account category"::Joint")then begin
//                         TestField(Name);
