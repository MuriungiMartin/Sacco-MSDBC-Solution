...
// Page 50058 "Payment Requests List"
///
/// Did not compile in NAV
// {
...
//         GenJnlLine."Shortcut Dimension 1 Code":='NAIROBI';
...
//          PayLine.Reset;
//          PayLine.SetRange(PayLine."Received From","No.");
//          PayLine.SetRange(PayLine."Cashier Bank Account",'');
...
//             if PayLine.Posted=true then
//             GenJnlLine."Document Type":=GenJnlLine."document type"::" "
//             else
//               GenJnlLine."Document Type":=GenJnlLine."document type"::Payment;
//             GenJnlLine."Account Type":=GenJnlLine."Account Type"::Member;
//             GenJnlLine."Account No.":="Payee No";
//             GenJnlLine.Validate(GenJnlLine."Account No.");
//             GenJnlLine."External Document No.":=Payments."Cheque No";
