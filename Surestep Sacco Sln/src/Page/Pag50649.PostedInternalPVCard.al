...
Page 50649 "Posted Internal PV Card"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    begin
        ...
        if PVLinesDetails.Find('-') then begin
            repeat
                ...
                "Cheque No" + ' ' + PVLinesDetails.Description, "Cheque No", GenJournalLine."application source"::" ");
                ...
                "Cheque No" + ' ' + PVLinesDetails.Description, '', GenJournalLine."application source"::" ");
