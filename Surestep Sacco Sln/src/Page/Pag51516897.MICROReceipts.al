...
//         Loans: Record "HR Transport Requisition Pass";
//         Commision: Decimal;
//         LOustanding: Decimal;
...
//                             GenJournalLine."Transaction Type" := GenJournalLine."transaction type"::"Deposit Contribution"
//                         else
//                             if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::Investment then
