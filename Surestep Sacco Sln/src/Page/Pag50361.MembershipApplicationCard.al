...
Page 50361 "Membership Application Card"
{
            ...
            group("Function")
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        /* FnCheckfieldrestriction;
                         ...
                         IF (ObjCust."No." <> "No.") AND ("Account Category"="Account Category"::Individual) AND (ObjCust.Status=ObjCust.Status::Active) THEN
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to create the selected accounts for the New Member?', false) = true then begin
                            ...
                            if ObjProductsApp.FindSet then begin
                                ...
                                ObjCust."Occupation Details" := "Employment Info";
                                ObjCust."Employer Code" := "Employer Code";
                                ObjCust."Employer Name" := "Employer Name";
                                ObjCust."Employer Address" := "Employer Address";
                                ObjCust."Terms Of Employment" := "Terms of Employment";
                                ObjCust."Date of Employment" := "Date of Employment";
                                ObjCust."Position Held" := "Position Held";
                                ObjCust."Expected Monthly Income" := "Expected Monthly Income";
                                ObjCust."Expected Monthly Income Amount" := "Expected Monthly Income Amount";
                                ...
                                ObjCust."First Name" := "First Name";
                                ObjCust."Middle Name" := "Middle Name";
                                ObjCust."Last Name" := "Last Name";
                                ...
                                ObjCust."E-Mail (Personal2)" := "E-Mail (Personal2)";
                                ...
                                ObjCust."Joint Account Name" := "Joint Account Name";
                                if "Account Category" = "account category"::Joint then
                                    ObjCust.Name := "Joint Account Name";
                                ...
                                ObjCust."Bank Branch Code" := "Bank Code";
                                ObjCust."Bank Branch Name" := UpperCase("Bank Branch Name");
                                ObjCust."Bank Name" := "Bank Name";
                                ...
                                if "Member Payment Type" = "member payment type"::"Standing Order" then begin
                                    if ObjNoSeries.Get then begin
                                        ...
                                        if VarStandingNo <> '' then begin
                                            ObjCust."Standing Order No" := VarStandingNo;
                                        end;
                                    end;
                                end;
                                ObjCust.Insert(true);
                        ...
                        Message('You have successfully Registered a New Sacco Member. Membership No=%1.The Member will be notifed via SMS and/or Email.', ObjCust."No.");
                ...
                action("Update KYC Details")
                {
                    ...
                    begin
                        ...
                        Message('You have successfully Updated the KYC Details for Member No=%1.The Member will be notifed via SMS and/or Email.', ObjCust."No.");
                        ...
                        if ObjGenSetUp."Send Membership Reg SMS" = true then begin
                            ...
                            ObjCust."No.", "Mobile Phone No");
                        end;

                        //======================================================================================================Send Email
                        if ObjGenSetUp."Send Membership Reg Email" = true then begin
                            FnSendKYCUpdateEmail("No.", "E-Mail (Personal)", "ID No.", ObjCust."No.");
                        end;
                        "KYC Completed" := true;
                    end;
                }
    ...
    begin
        ...
        IF ObjAccounts.FINDSET THEN
          BEGIN
             IF ObjCust.GET(VarMemberNo) THEN
              BEGIN
