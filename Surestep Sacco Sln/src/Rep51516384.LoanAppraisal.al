...
// 	{
// 		type(ForNav.Report_6_3_0_2259; ForNavReport51516384_v6_3_0_2259){}   
// 	}
// } // Reports ForNAV Autogenerated code - do not delete or modify -->

// Report 50384 "Loan Appraisal"
// {
// 	RDLCLayout = './Layouts/LoanAppraisal.rdlc'; DefaultLayout = RDLC;
...
// 			{
// 			}
// 			column(LInsurance; "Loans Register"."Loan Insurance")
// 			{
// 			}
...
// 			{
// 			}
// 			column(TopupCommissionR; "Loans Register"."Bank Statement Avarage Credits")
// 			{
// 			}
// 			column(TopUpCommission; "Loans Register"."Offset Commission")
// 			{
// 			}
// 			column(FinalDepMultiplier; FinalDepMultiplier)
// 			{
// 			}
// 			column(RecommS; RecommS)
// 			{
// 			}
// 			column(SpecialMultiplierAmount; "Loans Register"."Registration Date")
// 			{
// 			}
...
// 			{
// 			}
// 			column(Recommended_Amount; "Loans Register"."Recommended Amount")
// 			{
// 			}
...
// 			{
// 			}
// 			column(CollateralAmount0; CollateralAmount0)
// 			{
// 			}
...
// 			{
// 			}
// 			column(OtherIncomeAmt; "Loans Register"."Member Share Capital")
// 			{
// 			}
...
// 			{
// 			}
// 			column(NetIncome_LoansRegisterYYYYYYYYYYYYY; "Loans Register"."Net Income")
// 			{
// 			}
...
// 			{
// 			}
// 			column(OtherIncome_LoansRegister; LoanApp."Member Share Capital")
// 			{
// 			}
...
// 			{
// 			}
// 			column(TotalAllowances_LoansRegister; "Loans Register"."Salary Net Utilizable")
// 			{
// 			}
...
// 				{
// 				}
// 				column(CommisionAmountR; "Loan Offset Details"."FOSA Account")
// 				{
// 				}
...
// 				NetDibLoan:=0;
// 				NetProfit:=0;
// 				//  Deposits & Share Capital analysis
...
// 				TotalShareFigure:=Cshares+ShareCap;
// 				//MESSAGE('Totalsharefigure on its own %1',TotalShareFigure);
// 				// Biblia Deposit & Share Capital Analysis
// 				if LoanApp.Get("Loan  No.") then begin
// 				if LoanApp."Existing Loan Repayments" = true then begin
// 				  TotalShareFigure:=LoanApp."Registration Date";
// 				end else
// 				  TotalShareFigure:=(Cshares+ShareCap)*3;
// 				//MESSAGE('Total Share Figure for Biblia is %1',TotalShareFigure);
// 				if LoanApp."Existing Loan Repayments" = true then begin
// 				  FinalDepMultiplier:=LoanApp."Registration Date";
// 				end else
// 				  FinalDepMultiplier:=(Cshares+ShareCap)*3;
// 				end;
// 				// Biblia Deposit & Share Capital Analysis End
// 				if LoanType.Get("Loans Register"."Loan Product Type") then begin
// 				if LoanApp."Existing Loan Repayments" = true then
// 				DepositM:=Cshares*LoanType."Special Multiplier"+(ShareCap);
...
// 				RemainigDep:=((Cshares+ShareCap)-QualifyingDep);
...
// 				repeat
// 				CollateralAmount:=Collateral."Guarantee Value";
// 				CollateralAmount0:=CollateralAmount0+Collateral."Guarantee Value";
// 				until Collateral.Next=0;
// 				end;
// 				GshareCollateral:=CollateralAmount0+GShares;
// 				//End Collateral Details
// 				//Net Utilizable=2/3 of Gross-TotalDeductions
// 				MaximumEligible:="Loans Register"."Net Utilizable Amount";
// 				//Biblia Sallary Qualification
// 				if "Loans Register"."Repayment Method"="Loans Register"."repayment method"::Amortised then
// 				PrincipalAmountGlobal:=ROUND(MaximumEligible*((Power((1+"Loans Register".Interest/1200),Installments)-1)/(("Loans Register".Interest/1200)*(Power((1+"Loans Register".Interest/1200),Installments)))));
// 				// [LoanApplied/((1-(1+0.01)^-60)/0.01)]
// 				if PrincipalAmountGlobal<0 then begin
// 				  PrincipalAmountGlobal:=0;
// 				end ;
// 				Message('This is Qualification as per Salary %1,%2',PrincipalAmountGlobal,Installments);
// 				//SalaryQualAmt:=ROUND(200*(PrincipalAmountGlobal-(1/3*"Gross Pay"+("Other Incomes Amount")))); subject to Biblia Confirmation
// 				//MESSAGE('Member qualifies for this amount as per salary %1',SalaryQualAmt);
// 				//Recommended Amount
// 				/*Recomm:=ROUND(FnReccommendAmount("Loans Register"."Requested Amount",FinalDepMultiplier,TotalGuaranteed,PrincipalAmountGlobal,"Loan Collateral Details"."Guarantee Value"),100,'<');
// 				MESSAGE('%1',Recomm);*/
...
// 				Msalary:=ROUND(Psalary,0.05,'<');
// 				if  (salary>Repayment) or  (salary=Repayment) then
// 				Msalary:=ROUND(Psalary,0.05,'<')
// 				else
// 				  Msalary:=ROUND(Psalary,0.05,'<');
// 				//Recommended Amount
// 				if LoanApp."BSExpenses Food"=true then begin //this code is for qualification with only deposits and guarantors
// 				Message('This loan will not consider salary as a qualification');
// 				if "Loans Register".Source="Loans Register".Source::BOSA then begin
// 				//IF (FinalDepMultiplier >PrincipalAmountGlobal) THEN
// 				//Recomm:=ROUND(PrincipalAmountGlobal,0.05,'<')
// 				//ELSE
// 				// Recomm:=ROUND(FinalDepMultiplier,0.05,'<');
// 				if (FinalDepMultiplier >GshareCollateral) then
// 				Recomm:=ROUND(GshareCollateral,0.05,'<')
// 				else
// 				Recomm:=ROUND(FinalDepMultiplier,0.05,'<');
// 				//IF Recomm>GshareCollateral THEN
// 				//Recomm:=ROUND(GshareCollateral,0.05,'<');
// 				if Recomm>"Loans Register"."Requested Amount" then
// 				Recomm:=ROUND("Loans Register"."Requested Amount",0.05,'<');
// 				if Recomm<0 then begin
// 				Recomm:=ROUND(Recomm,0.05,'<');
// 				end;
// 				end else
// 				if (FinalDepMultiplier >GshareCollateral) then
// 				Recomm:=ROUND(GShares,0.05,'<')
// 				else
// 				if Recomm>(GshareCollateral) then
// 				Recomm:=ROUND((GshareCollateral),0.05,'<');
// 				if Recomm>"Loans Register"."Requested Amount" then
...
// 				if Recomm<0 then begin
// 				Recomm:=ROUND(Recomm,0.05,'<');
// 				/*IF "Loans Register".checksal =TRUE THEN BEGIN
// 				Recomm:=ROUND(Psalary,0.05,'<');
// 				END;*/
// 				"Recommended Amount":=Recomm;
// 				"Approved Amount":=Recomm;
// 				w:=(1/100*Recomm);
// 				NetDibLoan:=Netdisbursed*1/100;
// 				NetProfit:=w-NetDibLoan;
// 				"Bank Statement Avarage Debits":=NetProfit;
// 				Message('%1 , %2',"Bank Statement Avarage Debits", LoanApp."Loan Offset Amount");
// 				"Loans Register".Modify;
// 				end;
// 				//mwisho 1
// 				end else begin//this is calculation for both salary and guarantors and deposits
// 				if "Loans Register".Source="Loans Register".Source::BOSA then begin
// 				if (FinalDepMultiplier >PrincipalAmountGlobal) then
// 				Recomm:=ROUND(PrincipalAmountGlobal,0.05,'<')
// 				else
...
// 						  else begin
// 							  BoostedAmount2:=Cust.BoostedAmount;
// 							 // MESSAGE('The Total Boosted amount is %1',BoostedAmount2);s
// 						  end;
// 				BoostedAmount2:=Cust.BoostedAmount;
...
// 				ProductCharges.SetRange(ProductCharges."Loan Charge Type",ProductCharges."loan charge type"::"Loan Insurance");
...
// 					LoanInsurance:=LoanInsurance*"Boost this Loan"
// 					end else
// 					LoanInsurance:=LoanInsurance;
// 				end;
// 				LoanInsurance:=Recomm*1/100;
// 				"Loan Insurance":=LoanInsurance;
// 				Modify;
// 				//END;
// 				//END LOAN INSURANCE------------------------------------
// 				//LOAN PROCESSING FEE (LPF)--------------------------------
// 				if "Member Account Category"<>"member account category"::"7" then begin
// 				ProductCharges.Reset;
// 				ProductCharges.SetRange(ProductCharges."Product Code","Loan Product Type");
// 				//ProductCharges.SETRANGE(ProductCharges.Code,'LPROCESSINGFEE');
// 				ProductCharges.SetRange(ProductCharges."Loan Charge Type",ProductCharges."loan charge type"::"Loan Processing Fee");
// 				if ProductCharges.Find('-') then begin
// 				if ProductCharges."Use Perc"=true then begin
// 				LPFcharge:="Approved Amount"*(ProductCharges.Percentage/100); //*Installments;
// 				if LPFcharge<ProductCharges."Minimum Amount" then
// 				LPFcharge:=ProductCharges."Minimum Amount"
// 				end else
// 				LPFcharge:=ProductCharges.Amount;
// 				end;
// 				end;
// 				//ProcessingFee:=Recomm*0.5/100;
// 				ProcessingFee:=LPFcharge;
// 				"Loan Processing Fee":=ProcessingFee;
// 				Modify;
...
// 				Upfronts:=TotalBridgeAmount+LoanInsurance
// 				ELSE
...
// 				*/
// 				//kazih Upfronts:=TotalBridgeAmount+LoanInsurance;
...
// 				end;
// 				//
// 				VarAmountDisbursed:="Approved Amount";
// 				if "Notify Guarantor SMS"="notify guarantor sms"::"1" then
// 				  VarAmountDisbursed:="Boosted Amount Interest";
// 				"Recommended Amount":=Recomm;
// 				"Approved Amount":=Recomm;
// 				Upfronts:=TotalBridgeAmount+LoanInsurance+ProcessingFee;
// 				Netdisbursed:=VarAmountDisbursed - Upfronts;
// 				"Loan Disbursed Amount":=Netdisbursed;
// 				"Total Offset Amount":=TotalBridgeAmount;
// 				if TotalBridgeAmount<>0 then begin
// 				w:=(1/100*Recomm);
// 				NetDibLoan:=Netdisbursed*1/100;
// 				NetProfit:=w-NetDibLoan;
// 				end else begin
...
// 				end;
// 				"Bank Statement Avarage Debits":=NetProfit;
// 				"Bank Statement Net Income":=Netdisbursed;
// 				Modify;
...
// 				NetDibLoan:=Netdisbursed*1/100;
// 				NetProfit:=w-NetDibLoan;
// 				"Refinance Profit":=NetProfit;
// 				"Net To Be Disbursed":=Netdisbursed;
// 				"Loans Register".MODIFY;
// 				*/
// 				TotalMRepay:=0;
// 				LPrincipal:=0;
...
// 		CollateralAmount0: Decimal;
// 		SalaryQualAmt: Decimal;
// 		var1: Decimal;
// 		RecommS: Decimal;
// 		DepositM: Decimal;
// 		BibDepQualifier: Decimal;
// 		TotalShareFigure: Decimal;
// 		FinalDepMultiplier: Decimal;
// 		a: Decimal;
// 		b: Decimal;
// 		w: Decimal;
// 		x: Decimal;
...
// 	local procedure FnReccommendAmount(RequestedAmount: Decimal;QShares: Decimal;QGuarantors: Decimal;QSalary: Decimal;QCollateral: Decimal) RecommendedAmount: Decimal
// 	begin
...
// 		if RecommendedAmount > QCollateral then
// 		  RecommendedAmount := QCollateral;
...
// 	var 
// 		[WithEvents]
// 		ReportForNav : DotNet ForNavReport51516384_v6_3_0_2259;
