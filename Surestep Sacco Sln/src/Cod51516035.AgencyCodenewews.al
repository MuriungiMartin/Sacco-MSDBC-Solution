...
// Codeunit 50035 "AgencyCodenewews"
// {

//     trigger OnRun()
//     begin
//         Message(Format(PostBranchAgentTransaction('606188311391266')));
...
//         ObjVehicle: Record "Credit Score Setup";
...
//         begin
//         ObjVehicle.Reset;
//         ObjVehicle.SetRange(ObjVehicle."Vehicle Plate",idNumber);
//         if ObjVehicle.Find('-') then begin

//           Vendor.Reset;
//           Vendor.SetRange(Vendor."BOSA Account No",ObjVehicle."Member No");
//           if Vendor.Find('-') then begin
//           accounts:=accounts+'-:-'+Vendor."No."+':::'+Vendor.Name+':::Car:::'+Vendor."Phone No."+':::'+
//           Format(ObjVehicle."SACCO Contribution");
//           end;
//         end else begin
//            accounts:='none';
//           end;
...
//               AgentTransactions."Transaction Type":=AgentTransactions."transaction type"::"21";
...
//                 repeat
//                   LoansRegister.CalcFields(LoansRegister."Outstanding Balance",LoansRegister."Interest Due",LoansRegister."Outstanding Interest",LoansRegister."Interest Paid");
//                   if (LoansRegister."Outstanding Balance">0)or(LoansRegister."Outstanding Interest">0) then
...
//                   ':::'+Format(LoansRegister."Outstanding Balance"+LoansRegister."Outstanding Interest") ;;
...
//                             GenJournalLine."External Document No.":=AgentApps."Agent Code";
//                             GenJournalLine."Posting Date":=AgentTransactions."Transaction Date";
//                             GenJournalLine.Description:= AgentTransactions.Description +' '+AgentTransactions."Id No" +' ' +AgentTransactions."Physical Address"+' '+Format(AgentTransactions."Transaction Time") ;
//                             GenJournalLine.Amount:=AgentTransactions.Amount;
//                             GenJournalLine.Validate(GenJournalLine.Amount);
//                             GenJournalLine."Shortcut Dimension 1 Code":=Vendor."Global Dimension 1 Code";
//                             GenJournalLine."Shortcut Dimension 2 Code":=Vendor."Global Dimension 2 Code";
...
//                           AgentTransactions."transaction type"::"17",
//                           AgentTransactions."transaction type"::"13",
//                           AgentTransactions."transaction type"::"14":
//                             begin
...
//                                 GenJournalLine."Journal Batch Name":='Agency';
//                                 GenJournalLine."Line No.":=LineNo;
//                                 GenJournalLine."Account Type":=GenJournalLine."account type"::"7";
//                                 GenJournalLine."Account No.":=AgentTransactions."Account No.";
//                                 GenJournalLine.Validate(GenJournalLine."Account No.");
...
//                                 GenJournalLine."External Document No.":=AgentApps."Agent Code";
//                                 GenJournalLine."Posting Date":=AgentTransactions."Transaction Date";
//                                 GenJournalLine."Transaction Type" := GenJournalLine."transaction type"::"2";
...
//                                 GenJournalLine.Insert;
//                               end;
//                               if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"13") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                                 GenJournalLine."External Document No.":=AgentApps."Agent Code";
//                                 GenJournalLine."Posting Date":=AgentTransactions."Transaction Date";
//                                 GenJournalLine."Transaction Type" := GenJournalLine."transaction type"::"5";
//                                 GenJournalLine."Shortcut Dimension 1 Code":='BOSA';
//                                 GenJournalLine.Validate(GenJournalLine."Shortcut Dimension 1 Code");
//                                 GenJournalLine.Description:=AgentTransactions.Description;
//                                 GenJournalLine.Amount:=AgentTransactions.Amount;
...
//                                 GenJournalLine.Insert;
//                               end;
//                               if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"17") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                                 GenJournalLine.Insert;
//                               end;
//                               if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"14") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                                 GenJournalLine."External Document No.":=AgentApps."Agent Code";
//                                 GenJournalLine."Posting Date":=AgentTransactions."Transaction Date";
//                                 GenJournalLine."Transaction Type" := GenJournalLine."transaction type"::"7";
//                                 GenJournalLine."Shortcut Dimension 1 Code":='BOSA';
//                                 GenJournalLine.Validate(GenJournalLine."Shortcut Dimension 1 Code");
//                                 GenJournalLine.Description:=AgentTransactions.Description;
//                                 GenJournalLine.Amount:=AgentTransactions.Amount;
...
//                                     if AgentTransactions.Amount > LoansRegister."Outstanding Interest" then
//                                     GenJournalLine.Amount:=-LoansRegister."Outstanding Interest"
//                                     else
//                                     GenJournalLine.Amount:=-AgentTransactions.Amount;
//                                     GenJournalLine.Validate(GenJournalLine.Amount);
//                                     GenJournalLine."Transaction Type":=GenJournalLine."transaction type"::"3";
...
//                                     GenJournalLine.Amount:=-AgentTransactions.Amount;
//                                     GenJournalLine.Validate(GenJournalLine.Amount);
//                                     GenJournalLine."Transaction Type":=GenJournalLine."transaction type"::"4";
//                                     if GenJournalLine."Shortcut Dimension 1 Code" = '' then begin
//                                     GenJournalLine."Shortcut Dimension 1 Code":=Members."Global Dimension 1 Code";
//                                     GenJournalLine.Validate(GenJournalLine."Shortcut Dimension 1 Code");
//                                     end;
...
//                                AgentTransactions."transaction type"::"16",AgentTransactions."transaction type"::"15":
//                                  begin
//                                 AgentTransactions.Amount :=AgentTransactions.Amount*-1;
//                                if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"15") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                                 GenJournalLine.Insert;
//                               end;
//                                if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"16") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                            AgentTransactions."transaction type"::"21":
//                                begin
//                                  registrationup:=true;
//                           objNewAccount.Init;
...
//                              AgentTransactions."transaction type"::"16",AgentTransactions."transaction type"::"19",
//                              AgentTransactions."transaction type"::"15",AgentTransactions."transaction type"::"18":
//                                  begin
//                                 AgentTransactions.Amount :=AgentTransactions.Amount*-1;
//                                if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"15") then begin
//                                 LineNo:=LineNo+10000;
...
//                                 GenJournalLine.Insert;
//                                end;
//                                if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"19") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//                                 GenJournalLine."External Document No.":=AgentApps."Agent Code";
//                                 GenJournalLine."Posting Date":=AgentTransactions."Transaction Date";
//                                 GenJournalLine."Transaction Type" := GenJournalLine."transaction type"::"8";
//                                 GenJournalLine."Shortcut Dimension 1 Code":='BOSA';
//                                 GenJournalLine.Validate(GenJournalLine."Shortcut Dimension 1 Code");
//                                 GenJournalLine.Description:=AgentTransactions.Description;
//                                 GenJournalLine.Amount:=AgentTransactions.Amount;
...
//                                 GenJournalLine.Insert;
//                                end;
//                                if (AgentTransactions."Transaction Type"=AgentTransactions."transaction type"::"18") then begin
//                                 LineNo:=LineNo+10000;
//                                 GenJournalLine.Init;
//                                 GenJournalLine."Journal Template Name":='GENERAL';
//                                 GenJournalLine."Journal Batch Name":='Agency';
...
//             end;
//           AgentTran.AddText( Format(AgentTransactions."Transaction Time") +':::'+AgentTransactions."Id No"+':::' + Format(AgentTransactions.Amount*-1)+':::' + Format(AgentTransactions."Document No.")+'::::');
