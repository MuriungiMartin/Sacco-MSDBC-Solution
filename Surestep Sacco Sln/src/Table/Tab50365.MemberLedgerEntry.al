...
Table 50365 "Member Ledger Entry"
{
    ...
    begin
        ...
        "Loan No" := "Loan No";
        //Bett
        //Message('here %1-  d amount %2  credit - %4 - docuent no %3', "Customer No.", "Debit Amount", "Credit Amount", "Document No.");
    end;
    //Message('here %1- %2 - %3', "Customer No.", Amount, "Document No.");
