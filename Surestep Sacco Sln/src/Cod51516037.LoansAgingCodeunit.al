...
// Codeunit 50037 "Loans Aging Codeunit"
// {
...
//         SMSMessage."SMS Message":=SMSBody+'. Kingdom Sacco';
...
//     procedure FnSendSMSOTP(SMSSource: Text;SMSBody: Text;CurrentAccountNo: Text;MobileNumber: Text;VarOTPUser: Code[30];VarOTPCode: Integer)
//     var
//         SMSMessage: Record "SMS Messages";
//         iEntryNo: Integer;
//     begin
...
//         SMSMessage."SMS Message":=SMSBody+'. Kingdom Sacco';
//         SMSMessage."Telephone No":=MobileNumber;
//         SMSMessage."OTP Code":=VarOTPCode;
//         SMSMessage.OTP_User:=VarOTPUser;
//         if ((MobileNumber<>'') and (SMSBody<>'')) then
//         SMSMessage.Insert;
//     end;
...
//     begin
//         ObjBanks.Reset;
//         ObjBanks.SetRange(ObjBanks."Account Type",ObjBanks."account type"::"1");
...
//             LineNo:=LineNo+10000;
//             SFactory.FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"18",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",VarPostingDate,'Loan Penalty Charged - '+VarLoanNoRecovered,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanPenaltyBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Penalty Charged-------------------------------------------------------------------------------

//                       LineNo:=LineNo+10000;
//                       SFactory.FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"19",
//                       GenJournalLine."account type"::"7",VarMemberNo,VarPostingDate,AmountToDeduct*-1,'BOSA',EXTERNAL_DOC_NO,
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"17",
//                         GenJournalLine."account type"::"7",VarMemberNo,VarPostingDate,'Loan Interest Charged - '+VarLoanNoRecovered,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInterestDueBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);

//                       //--------------------------------Debit Loan Interest Due-------------------------------------------------------------------------------
//                       LineNo:=LineNo+10000;
//                       SFactory.FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"3",
//                       GenJournalLine."account type"::"7",VarMemberNo,VarPostingDate,AmountToDeduct*-1,'BOSA',EXTERNAL_DOC_NO,
...
//                 if (ObjLoans."Outstanding Balance"<>0) and (ObjLoans."Loan Status" = ObjLoans."loan status"::Disbursed) then
//                   begin
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"12",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",VarPostingDate,'Loan Insurance Charged - '+VarLoanNoRecovered,GenJournalLine."bal. account type"::"G/L Account",
...
//             'Loan Repayment - '+VarLoanNoRecovered+' '+ObjLoans."Loan Product Type Name",'',GenJournalLine."application source"::"0");
...
//           'Debt Collector Fee on Guarantor Reimbersment','',GenJournalLine."recovery transaction type"::"2",'');
...
//           'Debt Collection Fee + VAT from '+ObjGuarantorLedger."Defaulter Name",'',GenJournalLine."recovery transaction type"::"2",'');
...
//                       'Loan Recovery Reimbursment: '+ObjGuarantorLedger."Defaulter Name",'',GenJournalLine."recovery transaction type"::"2",'');
...
//               'Loan Guarantors Reimbursment','',GenJournalLine."recovery transaction type"::"2",'');
//         end;
...
//               SMTPSetup.Reset;
//               SMTPSetup.Get;
//                     SMTP.CreateMessage('Kingdom Sacco',SMTPSetup."Email Sender Address","Recepient Email",Subject,'',true);
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"12",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'Insurance Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInsuranceBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Insurance Due-------------------------------------------------------------------------------
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"18",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'Penalty Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanPenaltyBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Penalty Charged-------------------------------------------------------------------------------
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"17",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'Interest Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInterestDueBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Interest Due-------------------------------------------------------------------------------
...
//             SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//             GenJournalLine."account type"::Vendor,VarLoanSettlementAcc,VarPostingDate,VarAmounttoDeduct,'BOSA',EXTERNAL_DOC_NO,
//             'Loan Recovery'+'-'+VarMemberNo+'-'+VarMemberName,'',GenJournalLine."application source"::"0");
//         //==============================================================================================End Recover From Loan Settlement Account
//     end;
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"18",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'PayOff:Penalty Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanPenaltyBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Penalty Charged-------------------------------------------------------------------------------
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"17",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'PayOff:Interest Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInterestDueBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Interest Due-------------------------------------------------------------------------------
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"12",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'PayOff:Insurance Charged:_'+DOCUMENT_NO,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInsuranceBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Insurance Due-------------------------------------------------------------------------------
...
//             SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//             GenJournalLine."account type"::Vendor,VarLoanSettlementAcc,VarPostingDate,VarAmounttoDeduct,'BOSA',EXTERNAL_DOC_NO,
//             'Loan Payoff Recovery'+'-'+VarMemberNo+'-'+VarMemberName,'',GenJournalLine."application source"::"0");
//         //==============================================================================================End Recover From Loan Settlement Account
//     end;
...
//               if (ObjAccount."Over Draft Limit Expiry Date" <> 0D) and (ObjAccount."Over Draft Limit Expiry Date" < VarReportDate) and (ObjAccount.Balance < 0) then
//                 begin
...
//             if ObjLoansII.Get(VarLoanNo) then
//             begin
...
//               //=======================================================================================Amortised
//               if ObjLoans."Repayment Method"=ObjLoans."repayment method"::Amortised then
//               begin
...
//                 ObjProductCharge.SetRange(ObjProductCharge."Product Code",ObjLoans."Loan Product Type");
//                 ObjProductCharge.SetRange(ObjProductCharge."Loan Charge Type",ObjProductCharge."loan charge type"::"Loan Insurance");
//                 if ObjProductCharge.FindSet then
//                 begin
...
//               LineNo:=LineNo+10000;
//               FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//               GenJournalLine."account type"::Vendor,VarLoanSettlementAcc,VarPostingDate,AmountToDeduct,'FOSA','',
//               'Debt Collection Charge + VAT from '+VarLoanNoRecovered,'',GenJournalLine."application source"::"0");

//               LineNo:=LineNo+10000;
//               FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
...
//           begin
//             repeat
//             ObjMember.CalcFields(ObjMember."Deposits Contributed",ObjMember."Deposits Account Status",ObjMember."Deposits Contributed",ObjMember."Deposit Contributed Historical");
...
//                 VarDepositArrearsAmount:=VarMonthlyDepositContribution-(ObjMember."Deposits Contributed"+ObjMember."Deposit Contributed Historical");
...
//                 if ObjAccount.FindSet then
//                   begin
//                   if (ObjAccount."Exempt BOSA Penalty"=false) or ((ObjAccount."Exempt BOSA Penalty"=true) and (ObjAccount."Exemption Expiry Date"<WorkDate)) then
//                     begin
...
//                 'BOSA Deposits Penalty','',GenJournalLine."application source"::"0");
...
//                 'Tax: BOSA Deposits Penalty','',GenJournalLine."application source"::"0");
...
//         ObjDetailedVendorLedger.SETFILTER(ObjDetailedVendorLedger."Posting Date",VarDateFilter);
//         ObjDetailedVendorLedger.SETFILTER(ObjDetailedVendorLedger."Document No.",'<>%1','BALB/F9THNOV2018');
//         IF ObjDetailedVendorLedger.FINDSET THEN
//           BEGIN
//             ObjDetailedVendorLedger.CALCSUMS(ObjDetailedVendorLedger."Credit Amount");
...
//           if ObjMembers.FindSet then
//             begin
//             ObjMembers.CalcFields(ObjMembers."Deposits Contributed",ObjMembers."Deposit Contributed Historical");
//               VarExpectedMonthContribution:=ObjMembers."Monthly Contribution";
//               VarCurrMonthDepositArrears:=VarExpectedMonthContribution-(ObjMembers."Deposits Contributed"+ObjMembers."Deposit Contributed Historical");
//               end;
...
//         if VarTotalAmounttoRecover > 0 then
//         begin
...
//                 VarAccountBalBackDated:=FnRunGetAccountAvailableBalanceWithoutFreeze(ObjVendors."No.",WorkDate);

//                 if VarAccountBalBackDated<AvailableBal then
//                     AvailableBal:=VarAccountBalBackDated;
...
//                     'BOSA Deposits Transfer '+Format(VarPostingDate,0,'<Month Text,3> <Year4>')+' from '+ObjAccount."No.",'',GenJournalLine."application source"::"0");

//                     LineNo:=LineNo+10000;
//                     FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//                     GenJournalLine."account type"::Vendor,ObjAccount."No.",VarPostingDate,AmountToDeduct,'BOSA','',
//                     'BOSA Deposits Transfer '+Format(VarPostingDate,0,'<Month Text,3> <Year4>'),'',GenJournalLine."recovery transaction type"::"1",'');
...
//                         LineNo:=LineNo+10000;
//                         FnCreateGnlJournalLine(JournalTemplate,JournalBatch,DocNo,LineNo,GenJournalLine."transaction type"::"0",
...
//                       if ObjMemberAccount."No Of Signatories"=0 then
//                       begin
//                         VarSMSBody:= 'Ksh. ' +Format(ObjAccountLedger."Debit Amount") + ' debited from your Account No. ' + ObjAccountLedger."Vendor No." + ' - ' + ObjAccountLedger.Description +'. Kingdom Sacco';
//                         CloudPesa.SMSMessage(ObjAccountLedger."Document No.",ObjAccountLedger."Vendor No.",ObjMemberAccount."Mobile Phone No",VarSMSBody);
//                       end
//                       else
//                       begin
...
//                   if VarProcessDate<ObjGenSetUp."Go Live Date" then
//                   begin
...
//                 LineNo:=LineNo+10000;
//                 FnCreateGnlJournalLine(JournalTemplate,JournalBatch,DocNo,LineNo,GenJournalLine."transaction type"::"0",
//                 GenJournalLine."account type"::Vendor,ObjAccount."Savings Account No.",VarProcessDate,ObjAccount.Balance*-1,'FOSA','',
...
//                 LineNo:=LineNo+10000;
//                 FnCreateGnlJournalLine(JournalTemplate,JournalBatch,DocNo,LineNo,GenJournalLine."transaction type"::"0",
//                 GenJournalLine."account type"::Vendor,ObjAccount."Savings Account No.",VarProcessDate,VarUntransferedInterest*-1,'FOSA','',
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"18",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'Loan Penalty Charged - '+VarLoanNoRecovered,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanPenaltyBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Penalty Charged-------------------------------------------------------------------------------
...
//                         LineNo:=LineNo+10000;
//                         SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"12",
//                         GenJournalLine."account type"::"7",ObjLoans."Client Code",WorkDate,'Loan Insurance Charged - '+VarLoanNoRecovered,GenJournalLine."bal. account type"::"G/L Account",
//                         VarLoanInsuranceBalAccount,AmountToDeduct,'BOSA',VarLoanNoRecovered);
//                         //--------------------------------Debit Loan Insurance Due-------------------------------------------------------------------------------
...
//         ObjVendors.Reset;
//         ObjVendors.SetRange(ObjVendors."No.",VarFOSAAccountNo);
//         if ObjVendors.FindSet then
//         begin
//           ObjVendors.CalcFields(ObjVendors.Balance,ObjVendors."Uncleared Cheques");
//           VarBalanceinFOSA:=FnRunGetAccountAvailableBalance(VarFOSAAccountNo);;

//           if ObjBOSARefundLedger."Account No Recovered" = VarFOSAAccountNo then
//           begin //IF FUNDS ARE DEPOSITED TO BOSA ACCOUNT APPORTION DEPOSITED AMOUNT AS REFUNDED
...
//               if ObjExpectedTurnOversetup.Find('-') then
//                 begin
//                   repeat
//                   if (VarMonthlyTurnOverAmount>=ObjExpectedTurnOversetup."Minimum Amount") and (VarMonthlyTurnOverAmount<=ObjExpectedTurnOversetup."Maximum Amount") then
//                     begin
//                       if ObjCust.Get(VarMemberNo) then begin
...
//                     if (ObjNoSeries.Get) and (VarAmounttoFreeze > 1) then
//                     begin
...
//                 VarAvailableBalance:=FnRunGetAccountAvailableBalance(VarAccountNo);
//                 if (VarAvailableBalance > 1) and (VarAmounttoFreeze > 1) then
//                 begin
//                   if VarLoanDueAmount>VarAvailableBalance then
//                   begin
//                     VarAmounttoFreeze:=VarAvailableBalance
...
//         if ObjInterestLedger.FindSet=false then
//           begin
//              ObjLoans.Reset;
...
//         if ObjStandingOrders.FindSet then
//           begin
//           if (ObjStandingOrders."Next Run Date"=VarStandingRunDate) or (ObjStandingOrders."Next Attempt Date"=VarStandingRunDate) then
//             begin
...
//               if AvailableBal>=ObjStandingOrders.Amount then
//                 begin
...
//                   ObjStandingOrders."Source Account Narrations",'',GenJournalLine."application source"::"1");
...
//                         ObjStandingOrders."Destination Account Narrations",'',GenJournalLine."application source"::"1");
//                       end;
...
//                         if ObjFosaCharges.FindSet then
//                           begin
//                             if ObjFosaCharges."Use Percentage"=true then
//                               begin
...
//                           LineNo:=FnRunGetNextJvLineNo(BATCH_TEMPLATE,BATCH_NAME);
//                           FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
...
//         if ObjStandingOrders."Execute Condition"=ObjStandingOrders."execute condition"::"If no Funds Retry Standing Order" then
//           begin


//               //==============================================================================================================Finalize for Failed Standing Order
//               if (AvailableBal<ObjStandingOrders.Amount) and (ObjStandingOrders."Next Attempt Date"=ObjStandingOrders."End of Tolerance Date") then
//                 begin
//                   ObjGenSetUp.Get();
//                   ObjFosaCharges.Reset;
...
//                       AvailableBal:=FnRunGetAccountAvailableBalanceWithoutFreeze(ObjStandingOrders."Source Account No.",WorkDate);
//                       if  AvailableBal>(VarStoFeeSuccess+(VarStoFeeSuccess*ObjGenSetUp."Excise Duty(%)"/100)) then
//                         begin
//                         //=======================================================================================================1. DEBIT FOSA  A/C STO Charge
//                         LineNo:=FnRunGetNextJvLineNo(BATCH_TEMPLATE,BATCH_NAME);
//                         FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
...
//         if ObjStandingOrders."Execute Condition"=ObjStandingOrders."execute condition"::"If no Funds Fail Standing Order" then
//           begin
//                AvailableBal:=FnRunGetAccountAvailableBalanceWithoutFreeze(ObjStandingOrders."Source Account No.",WorkDate);
//               if (AvailableBal<ObjStandingOrders.Amount)  then
//                 begin
...
//               if ObjStandingOrders."Source Account Type"=ObjStandingOrders."source account type"::"G/L Standing Order" then
//                 begin
//                 VarSourceAccountType:=Varsourceaccounttype::"G/L Account"
//                   end else
//               if ObjStandingOrders."Source Account Type"=ObjStandingOrders."source account type"::"Supplier Standing Order" then
//                 begin
//                   VarSourceAccountType:=Varsourceaccounttype::Vendor
//                   end;

//               if ObjStandingOrders."Destination Account Type"=ObjStandingOrders."destination account type"::"G/L Account" then
//                 begin
//                 VarDestinationAccountType:=Vardestinationaccounttype::"G/L Account"
//                   end else
//               if ObjStandingOrders."Destination Account Type"=ObjStandingOrders."destination account type"::"Supplier Account" then
//                 begin
...
//              //=====================================================================================1. DEBIT SOURCE  A/C
//                LineNo:=FnRunGetNextJvLineNo(BATCH_TEMPLATE,BATCH_NAME);
//               FnCreateGnlJournalLineBranch(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//               VarSourceAccountType,ObjStandingOrders."Source Account No.",Today,ObjStandingOrders.Amount,'BOSA','',
//               ObjStandingOrders."Source Account Narrations",'',GenJournalLine."application source"::"1",ObjStandingOrders."Source Global Dimension 2 Code");
...
//               ObjStandingOrders."Destination Account Narrations",'',GenJournalLine."application source"::"1",ObjStandingOrders."Dest. Global Dimension 2 Code");
...
//                           (ObjAccountsII."Specific OD Sweeping Account" = ObjAccounts."No.")) then
//                       begin
...
//                         ObjAccountsII.CalcFields(ObjAccountsII."Balance (LCY)");
//                         VarODBalance:=ObjAccountsII."Balance (LCY)";
//                         if (VarAvailableOtherFOSAAccounts>0) and (VarODBalance<0) then
//                           begin
//                         if (VarODBalance*-1)>VarAvailableOtherFOSAAccounts then
//                           begin
...
//                               'Overdraft Sweeping to - '+ObjAccountsII."No.",'',GenJournalLine."application source"::"1");

//                             //------------------------------------2. Credit OD Account---------------------------------------------------------------------------------------------
//                               LineNo:=LineNo+10000;
//                               FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//                               GenJournalLine."account type"::Vendor,ObjAccountsII."No.",WorkDate,VarAmountDeducted*-1,'FOSA','',
//                               'Overdraft Sweeping From - '+ObjAccounts."No.",'',GenJournalLine."application source"::"1");
//                               //--------------------------------(Credit OD Account)---------------------------------------------
...
//                       if VarAvailableOtherFOSAAccounts<0 then
//                         begin
...
//                             'Overdraft Sweeping to - '+ObjAccounts."No.",'',GenJournalLine."application source"::"1");

//                           //------------------------------------2. Credit FOSA Account---------------------------------------------------------------------------------------------
//                             LineNo:=LineNo+10000;
//                             FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//                             GenJournalLine."account type"::Vendor,ObjAccounts."No.",WorkDate,VarAvailableOtherFOSAAccounts,'FOSA','',
//                             'Overdraft Sweeping From - '+ObjAccountsII."No.",'',GenJournalLine."application source"::"1");
//                             //--------------------------------(Credit OD Account)---------------------------------------------
...
//         if ObjUnPaidStoCharge.FindSet then
//           begin
//             repeat
...
//               if VarBalanceinFOSA>=ObjUnPaidStoCharge."Amount Charged" then
//                 begin
...
//                       'Unpaid Failed Standing Order Charge - '+ObjUnPaidStoCharge."Document No",'',GenJournalLine."recovery transaction type"::"2",'');
...
//                       'Tax: Unpaid Failed Standing Order Charge - '+ObjUnPaidStoCharge."Document No",'',GenJournalLine."recovery transaction type"::"2",'');
...
//                       'Unpaid Failed Standing Order Charge - '+ObjUnPaidStoCharge."Account No",'',GenJournalLine."recovery transaction type"::"2",'');
...
//                       'Tax: Unpaid Failed Standing Order Charge - '+ObjUnPaidStoCharge."Account No",'',GenJournalLine."recovery transaction type"::"2",'');

//                       ObjUnPaidStoCharge."Amount Paid Back":=ObjUnPaidStoCharge."Amount Paid Back"+ VarAmounttoDeduct;
//                       if ObjUnPaidStoCharge."Amount Charged"=ObjUnPaidStoCharge."Amount Paid Back" then
//                         begin
...
//         if ObjScheduledStatement.FindSet then
//           begin
//             repeat
...
//                   Filename:='';
//                   FilePath:='';
//                   if ObjScheduledStatement."Output Format" = ObjScheduledStatement."output format"::EXCEL then
//                   begin
...
//                   end else
//                   if ObjScheduledStatement."Output Format" = ObjScheduledStatement."output format"::Pdf then
//                   begin
...
//         if ObjFixedAssetDeprDetails.FindSet then
//           begin
//             repeat
//               DocNo:=FnRunGetNextTransactionDocumentNo;
//               ObjFixedAssetDeprDetails.CalcFields(ObjFixedAssetDeprDetails."Book Value",ObjFixedAssetDeprDetails."Acquisition Cost");
...
//                 if ObjFixedAsset.Get(ObjFixedAssetDeprDetails."FA No.") then
//                   begin
//                     if ObjFixedAsetPostingGroup.Get(ObjFixedAssetDeprDetails."FA Posting Group") then
//                       begin
//                         if VarAssetDeprValue>1 then
//                           begin
//                           LineNo:=LineNo+10000;
...
//     procedure FnCreateFADepreciationJournalLines(TemplateName: Text;BatchName: Text;DocumentNo: Code[30];LineNo: Integer;FAPostingType: Option " ","Registration Fee","Share Capital","Interest Paid","Loan Repayment","Deposit Contribution","Insurance Contribution","Benevolent Fund",Loan,"Unallocated Funds",Dividend,"FOSA Account","Loan Insurance Charged","Loan Insurance Paid";AccountNo: Code[50];TransactionDate: Date;TransactionDescription: Text;TransactionAmount: Decimal;DimensionActivity: Code[40];DimensionBranch: Code[40];FAPostingDate: Date)
//     var
...
//         if ObjLoanCalculator.FindSet then
//           begin
//             if ObjLoanCalculator."Repayment Frequency"=ObjLoanCalculator."repayment frequency"::Daily then
//             Evaluate(VarInPeriod,'1D')
//             else if ObjLoanCalculator."Repayment Frequency"=ObjLoanCalculator."repayment frequency"::Weekly then
//             Evaluate(VarInPeriod,'1W')
//             else if ObjLoanCalculator."Repayment Frequency"=ObjLoanCalculator."repayment frequency"::Monthly then
//             Evaluate(VarInPeriod,'1M')
//             else if ObjLoanCalculator."Repayment Frequency"=ObjLoanCalculator."repayment frequency"::Quaterly then
//             Evaluate(VarInPeriod,'1Q');
...
//             //=======================================================================================Strainght Line
//             if ObjLoanCalculator."Repayment Method"=ObjLoanCalculator."repayment method"::"Straight Line" then
//               begin
//               ObjLoanCalculator.TestField(ObjLoanCalculator.Installments);
//               VarLPrincipal:=ROUND(VarLoanAmount/VarRepayPeriod,1,'>');
//               VarLInterest:=ROUND((VarInterestRate/1200)*VarLoanAmount,1,'>');
...
//             //=======================================================================================Reducing Balance
//             if ObjLoanCalculator."Repayment Method"=ObjLoanCalculator."repayment method"::"Reducing Balance" then
//               begin
//               ObjLoanCalculator.TestField(ObjLoanCalculator."Interest rate");
//               ObjLoanCalculator.TestField(ObjLoanCalculator.Installments);
//               VarLPrincipal:=ROUND(VarLoanAmount/VarRepayPeriod,1,'>');
...
//             //=======================================================================================Constant
//             if ObjLoanCalculator."Repayment Method"=ObjLoanCalculator."repayment method"::Constants then
//               begin
...
//               if ObjInterestRatessetup.FindLast then
//                 begin
...
//               if ObjInterestRatessetup.Find('-') then
//                 begin
//                   repeat
//                   if (ObjAccount.Balance>=ObjInterestRatessetup."Minimum Balance") and (ObjAccount.Balance<=ObjInterestRatessetup."Maximum Balance") then
//                       begin
...
//                        if ObjInterestEarnedBuffer.FindLast then
//                          begin
...
//                       GenJournalLine."application source"::"1");
...
//                       'Tax: Interest Earned '+Format(WorkDate,0,'<Month Text,3> <Year4>'),'',GenJournalLine."application source"::"1");
...
//             if VarDocumentNo<>'' then
//               begin
//                 if ObjAccountTypes.Get(VarAccountType) then
//                   begin
...
//             if (AvailableBal>0) and (ObjAccounts."Excess Repayment Rule"<>ObjAccounts."excess repayment rule"::"Exempt From Excess Rule") then
//             begin
...
//                           'Excess Principal Paid from '+ObjAccounts."No."+' to '+ObjLoans."Loan Product Type Name",'',GenJournalLine."application source"::"1");

//                         //------------------------------------2. Credit Loan Account---------------------------------------------------------------------------------------------
//                           LineNo:=LineNo+10000;
//                           FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"4",
//                           GenJournalLine."account type"::"7",VarMemberNo,WorkDate,VarAmounttoDeduct*-1,'BOSA','',
//                           'Excess Principal Paid from '+ObjAccounts."No."+' to '+ObjLoans."Loan Product Type Name",VarLoantoOverpay,GenJournalLine."application source"::"1");
//                           //--------------------------------(Credit Loan Account)---------------------------------------------
...
//                 'Debt Collection Charge + VAT from '+VarLoanNo+ ObjLoans."Client Name",'',GenJournalLine."application source"::"1");

//                 LineNo:=LineNo+10000;
//                 FnCreateGnlJournalLine(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//                 GenJournalLine."account type"::Vendor,ObjLoans."Loan Debt Collector",WorkDate,AmountToDeduct*-1,'BOSA',VarLoanNo,
//                 'Debt Collection Charge + VAT from '+VarLoanNo+ ObjLoans."Client Name",VarLoanNo,GenJournalLine."application source"::"1");
//                   VarRunBal:=RunningBalance-AmountToDeduct;
//                 exit(VarRunBal);
//               end;
//             end;
...
//         if ObjAccounts.FindSet then
//           begin
//             if ObjProductType.Get(ObjAccounts."Account Type") then
//               begin
...
//                     ObjDormancyRegister."Status Post_Change":=ObjDormancyRegister."status post_change"::"2";
...
//                       (ObjAccounts.Status<>ObjAccounts.Status::Frozen) then
//                       begin
...
//               if ObjAccountLedgerII.FindSet then
//                 begin
...
//               if ObjAccountLedgerIII.FindSet then
//                 begin
...
//                 if VarContributionsTotal >2 then
//                   begin
...
//                       'Member Recruitment Comm. - '+Format(WorkDate,0,'<Month Text,3> <Year4>'),'',GenJournalLine."recovery transaction type"::"1");
...
//                       'Member Recruitment Comm. - '+ObjMembersIV."Referee Member No"+' - '+Format(WorkDate,0,'<Month Text,3> <Year4>'),'',GenJournalLine."recovery transaction type"::"1");
...
//         if ObjIssuesTracker.FindSet then
//           begin
//             repeat
//               if ObjIssuesTracker."Action Date" <> 0D then
//               begin
//                 ObjIssuesTracker."Day Past":=WorkDate-ObjIssuesTracker."Action Date";

//                 ObjAuditSetup.Get;
//                 if ObjIssuesTracker."Audit Opinion On Closure"=ObjIssuesTracker."audit opinion on closure"::Closed then
//                 begin
//                   ObjIssuesTracker.Status:=ObjIssuesTracker.Status::Closed
//                 end else
//                 if ObjIssuesTracker."Audit Opinion On Closure"=ObjIssuesTracker."audit opinion on closure"::Failed then
//                 begin
...
//                  (ObjIssuesTracker."Day Past">ObjAuditSetup."Over Due Date") then
//                 begin
//                   ObjIssuesTracker.Status:=ObjIssuesTracker.Status::OverDue
//                 end else
//                 if (ObjIssuesTracker."Audit Opinion On Closure"=ObjIssuesTracker."audit opinion on closure"::"Issue Assurance Not Yet Done") and
//                  (ObjIssuesTracker."Day Past">ObjAuditSetup."Due Date") then
//                 begin
...
//         if ObjMemberAccounts.FindSet then
//           begin
//             if ObjCust.Get(ObjMemberAccounts."BOSA Account No") then
//               begin
...
//             ObjAuditGeneralSetup.Get;
//             if ((VarMonthsCredittoDate+VarTransactionAmount)>VarMonthsCreditWithTolerance) and (VarMonthsCreditWithTolerance>0) then
//               begin
//                 VarSuspicious:=true;
//                 exit(VarSuspicious);
//               end;
...
//                 'Debt Collector Fee on OD','',GenJournalLine."recovery transaction type"::"2",'');

//                 //======================================================================================================Recovery to Debt Collector
//                 LineNo:=LineNo+10000;
//                 FnCreateGnlJournalLineGuarantorRecovery(BATCH_TEMPLATE,BATCH_NAME,DOCUMENT_NO,LineNo,GenJournalLine."transaction type"::"0",
//                 GenJournalLine."account type"::Vendor,ObjAccount."OD Debt Collector",WorkDate,VarDebtCollectorFee*-1,'BOSA',EXTERNAL_DOC_NO,
//                 'Debt Collection Fee + VAT from '+ObjAccount.Name,'',GenJournalLine."recovery transaction type"::"2",'');
